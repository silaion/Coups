...
public class usediscouponlistActivity extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String names[]={"한경카페 모든음료 1000원 할인권","한경카페 치즈케익 10% 할인권","안성카페 모든음료 1000원 할인권",};

        String teams[]={"유효기간 (2014.4.1~2014.6.31)","유효기간 (2014.9.1~2014.12.31)","유효기간 (2014.9.1~2014.12.31)"};
